...
# Not used. Saved here in case we needed in the future.
# def vec2quat(vec, up=(0.0, 1.0, 0.0)):
#     """
#     Taken from: https://behavior.stanford.edu/omnigibson/reference/utils/transform_utils.html#utils.transform_utils.vec2quat
