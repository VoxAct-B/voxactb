...
WRIST2_RGB_FOLDER = 'wrist2_rgb'
WRIST2_DEPTH_FOLDER = 'wrist2_depth'
WRIST2_MASK_FOLDER = 'wrist2_mask'
...
TTT_FILE = 'task_design_open_jar.ttt'
# TTT_FILE = 'task_design_open_drawer.ttt'

DEPTH_SCALE = 2**24 - 1

DOMINANT_ASSISTIVE_MODES = ['open_drawer_close_to_drawer_dominant_assistive', 'open_jar_close_to_jar_dominant_assistive', 'put_item_in_drawer_close_to_drawer_dominant_assistive', 'open_jar_noises_starting_states_dominant_assistive', 'open_drawer_noises_starting_states_dominant_assistive', 'put_item_in_drawer_noises_starting_states_dominant_assistive', 'hand_over_item_noises_starting_states_dominant_assistive']
