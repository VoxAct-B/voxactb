...
class Scene(object):
    ...
    def get_observation(self) -> Observation:
        ...
        wrist2_rgb, wrist2_depth, wrist2_pcd = get_rgb_depth(
            self._cam_wrist2, wc_ob.rgb, wc_ob.depth, wc_ob.point_cloud,
            wc_ob.rgb_noise, wc_ob.depth_noise, wc_ob.depth_in_meters)
    ...
    def _set_camera_properties(self) -> None:
        ...
        _set_rgb_props(
            self._cam_wrist2, self._obs_config.wrist_camera.rgb,
            self._obs_config.wrist_camera.depth,
            self._obs_config.wrist_camera)
        _set_rgb_props(
    ...
    def _get_misc(self):
        ...
        misc.update(_get_cam_data(self._cam_wrist2, 'wrist_camera2'))
        return misc
